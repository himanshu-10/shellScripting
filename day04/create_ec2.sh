#!/bin/bash
set -euo pipefail  # error handling in beautifull manner


# check aws is install or not , 
check_awscli() {
...
# waiting for instance state till running
...
main() {
    ...
    SUBNET_ID="subnet-03fbc3794aaeb249e"
    SECURITY_GROUP_IDS="sg-045186cd44dce089d"  # Add your security group IDs separated by space
